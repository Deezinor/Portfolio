...
const experience = [
  ...
  {
    period: "2023 - 2024",
    title: "VR & AR Masters Degree",
    description:
      "VR/AR application development, 3D asset creation, and User-Experience Design",
  },
  {
    period: "February 2021 - June 2021",
    title: "Design & Technology Cover Teacher ",
    description: "Taught years 7-13 across GCSE, A-Level & IB",
  },
  {
    period: "2017 - 2021",
    title: "Research & Development Coordinator",
    description:
      "Workflow & Systems Optimisation, Product Design, Project Development",
  },
];
...
const skills = [
  ...
  { category: "Version Control", level: 90 },
];
...
/*const awards = [
    {
        awardName: "Jury Prize",
        competition: "Innovate UK Immersive Tech Awards 2024",
        date: "March 2024"
    },
    {
        awards: "Best Use of Technology",
        competition: "Digital Heritage 2024",
        date: "July 2024"
    },
    {
        awardName: "Utility & Tools Runner's Up",
        competition: "XR Hack - Istanbul",
        date: "August 2024"
    }
]*/
            ...
            <div>
              ...
              <ScrollReveal priority delay={0.1}>
                <p className="text-body-lg text-muted mb-6">
                  XR Technical Artist based just outside of London, UK. I
                  specialize in turning complex 3D models into optimised,
                  real-time assets for XR experiences.
                </p>
              </ScrollReveal>
              <ScrollReveal priority delay={0.2}>
                <p className="text-body text-muted mb-6">
                  My journey started with traditional 3D modeling and Product
                  Design, which quickly evolved into technical artistry as I
                  discovered the intersection of high-fidelity visuals and
                  real-time performance. Today, I help teams bridge the gap
                  between complex CAD models and performant XR applications.
                </p>
              </ScrollReveal>
              <ScrollReveal priority delay={0.3}>
