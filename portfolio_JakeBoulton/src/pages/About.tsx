...
const experience = [
  {
    period: "2024 - Present",
    title: "Freelance XR Technical Artist",
    description:
      "Asset optimisation, XR experience design, AI workflow development",
  },
  {
    period: "2023 - 2024",
    title: "XR Developer",
    description: "VR/AR application development and 3D asset creation",
  },
  {
    period: "2020 - 2023",
    title: "3D Artist & Designer",
    description: "Archviz, product visualization, and 3D art projects",
  },
];
            ...
            <div>
              ...
              <ScrollReveal delay={0.1}>
                <p className="text-body-lg text-muted mb-6">
                  XR Technical Artist based in [Location]. I specialize in
              ...
              <ScrollReveal delay={0.2}>
                <p className="text-body text-muted mb-6">
                  My journey started with traditional 3D modeling and evolved
                  into technical artistry as I discovered the intersection of
                  high-fidelity visuals and real-time performance. Today, I help
                  teams bridge the gap between complex CAD models and performant
                  XR applications.
                </p>
              </ScrollReveal>
              <ScrollReveal delay={0.3}>
                <p className="text-body text-muted">
                  ...
                  you'll find me experimenting with AI workflows and sharing my
                  learnings on my blog.
                </p>
              </ScrollReveal>
            </div>
          </div>
