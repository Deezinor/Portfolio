...
const BeatBox: React.FC = () => {
  const data = {
    ...
    projectDescription: (
      <>
        <span className="font-medium text-gray-950">BeatBox Studio</span> is a
        VR drumming simulator and educational platform, offering freeplay,
    ...
    roleDescription: (
      <>
        ...
        <span className="font-medium text-gray-950">Blender</span>, with
        textures crafted in{" "}
        <span className="font-medium text-gray-950">
        ...
        <br />
        <br />
        Following the submission of the project&apos;s first draft for peer
        review in our Master&apos;s program, I incorporated feedback regarding
        the UI and overall user experience of the application. I facilitated a
        team discussion to identify actionable improvements and guided the
        implementation process to enhance the final design.
      </>
    ),
    projectBrief: (
      <>
        Design and build simple VR environments with realistic looking graphics
        and lighting Describe how VR is different from other media, including
        its effects on human perception
      </>
    ),
    teamMembers: (
      <>
