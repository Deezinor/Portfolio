      ...
      <>
        <div className="text-lg/[1.75]">
          ...
          <p>
            ...
            artifacts found within the museum. This accuracy was reinforced
            through continuous fact-checking and collaboration with museum
            experts.
          </p>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              <span className="font-medium text-gray-7.00">Lighting</span> to
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <span className="font-medium text-gray-7.00">Procreate</span> –
            ...
            <li>
              <span className="font-medium text-gray-7.00">Unity & C#</span> –
